	...
	<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
		<div class="min-height-200px">
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
				{!! Former::horizontal_open()->action(URL::route("industries.store"))->method('POST')->class('p-t-15')->role('form')->id('form') !!}     
				<div class="form-group">
					{!! Former::text('name')->placeholder('Industry Name')->label('Middle Name')->label('Industry Name') !!}
				</div>
				<div class="form-group">
					{!! Former::submit('Save') !!}
				</div>
