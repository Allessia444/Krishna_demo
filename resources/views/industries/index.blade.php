					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<div class="pull-right">
								<a href="{!! route('industries.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add Industry</a>
							</div>
						</div>
					</div>
				</div>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="{!!route('industries.show',['id'=>$industry->id])!!}"><i class="fa fa-eye"></i> View</a>
											<a class="dropdown-item" href="{!!route('industries.edit',['id'=>$industry->id])!!}"><i class="fa fa-pencil"></i> Edit</a>
