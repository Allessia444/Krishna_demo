					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<div class="pull-right">
								<a href="{!! route('task_categories.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add Task Category</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
				<div class="row">
					<table class="data-table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus datatable-nosort">Task Category Name</th>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="{!!route('task_categories.show',['id'=>$task_category->id])!!}"><i class="fa fa-eye"></i> View</a>
											<a class="dropdown-item" href="{!!route('task_categories.edit',['id'=>$task_category->id])!!}"><i class="fa fa-pencil"></i> Edit</a>
