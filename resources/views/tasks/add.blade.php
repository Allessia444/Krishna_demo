    ...
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                {!! Former::horizontal_open()->action(URL::route("tasks.store"))->method('POST')->class('p-t-15')->role('form')->id('form') !!}     
                {!! Former::select('task_category_id')->label('Task Categories')->options($tasks)->placeholder('Task Categories') !!}  
            ...
            <div class="col-lg-12 col-sm-12">
                ...
                <div class="custom-control">
                    <input type="radio" class="with-gap" name="priority" value="none">None
                    <input type="radio" class="with-gap" name="priority" value="low">Low
                    <input type="radio" class="with-gap" name="priority" value="high">High
                    <input type="radio" name="priority" class="with-gap" value="medium">Medium
                </div>
            </div>
            <div class="form-group">
                {!! Former::submit('Save') !!}
