					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<div class="pull-right">
								<a href="{!! route('tasks.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add Task</a>
							</div>
						</div>
					</div>
				</div>
					...
					<table class="data-table stripe hover nowrap">
						...
						<tbody>
							...
							<tr>
								...
								<td>{!! $task->task_category ? $task->task_category->name : '' !!}</td>
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="{!!route('tasks.show',['id'=>$task->id])!!}"><i class="fa fa-eye"></i> View</a>
											<a class="dropdown-item" href="{!!route('tasks.edit',['id'=>$task->id])!!}"><i class="fa fa-pencil"></i> Edit</a>
