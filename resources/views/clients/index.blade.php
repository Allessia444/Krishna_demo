					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<div class="pull-right">
								<a href="{!! route('clients.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add Client</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
				<div class="row">
					<table class="data-table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus datatable-nosort">Industry Name</th>
								<th>Client Name</th>
								<th>Email</th>
						...
						<tbody>
							...
							<tr>
								<td class="table-plus">{!! $client->industry->name !!}</td>
								<td>{!! $client->name !!}</td>
								<td>{!! $client->email !!}</td>
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="{!!route('clients.show',['id'=>$client->id])!!}"><i class="fa fa-eye"></i> View</a>
											<a class="dropdown-item" href="{!!route('clients.edit',['id'=>$client->id])!!}"><i class="fa fa-pencil"></i> Edit</a>
