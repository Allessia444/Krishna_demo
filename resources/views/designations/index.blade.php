					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<div class="pull-right">
								<a href="{!! route('designations.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add Designation</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<table class="data-table stripe hover nowrap">
						...
						<tbody>
							...
							<tr>
								<td class="table-plus">{!! $designation->name !!}</td>
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="{!!route('designations.show',['id'=>$designation->id])!!}"><i class="fa fa-eye"></i> View</a>
											<a class="dropdown-item" href="{!!route('designations.edit',['id'=>$designation->id])!!}"><i class="fa fa-pencil"></i> Edit</a>
