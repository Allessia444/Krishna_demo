					...
					<div class="clearfix">
					 ...
					 {!! Former::open()->method('PATCH')->action(route('users.update',$user->id)) !!}    
							...
							<div class="row">
								<div class="col-md-6 col-sm-12">
									...
									<div class="custom-control">
										<input type="radio" class="with-gap" @if($user->gender == 'male') checked @endif name="gender" value="male">Male
									</div>
									<div class="custom-control">
										<input type="radio" name="gender" @if($user->gender == 'female') checked @endif class="with-gap" value="female">Female
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							{!! Former::text('dob')->placeholder('dob')->label('Middle Name')->class('form-control date-picker') !!}
						</div>
						<div class="form-group">
							<div class="row">
								<div class="col-md-6 col-sm-12">
									...
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" name=hobby[] selected="{!!  in_array('Dancing', explode(',',$user->hobby)) ? 'selected' : '' !!}" value="Dancing" class="custom-control-input" id="customCheck1">
										<label class="custom-control-label" for="customCheck1">Dancing</label>
									</div>
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" value="Signing" selected="{!!  in_array('Signing', explode(',',$user->hobby)) ? 'selected' : '' !!}" name=hobby[] class="custom-control-input" id="customCheck2">
										<label class="custom-control-label" for="customCheck2">Signing</label>
									</div>
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" value="Reading" selected="{!!  in_array('Reading', explode(',',$user->hobby)) ? 'selected' : '' !!}" name=hobby[] class="custom-control-input" id="customCheck2">
										<label class="custom-control-label" for="customCheck2">Reading</label>
									</div>
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" value="Advancher" name=hobby[] selected="{!!  in_array('Advancher', explode(',',$user->hobby)) ? 'selected' : '' !!}" class="custom-control-input" id="customCheck2">
