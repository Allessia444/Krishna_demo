					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<div class="pull-right">
								<a href="{!! route('blog_categories.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add Blog Category</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
				<div class="row">
					<table class="data-table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus datatable-nosort">Blog category Name</th>
								<th>Main Blog Category Name</th>
								<th class="datatable-nosort">Action</th>
							</tr>
						</thead>
						<tbody>
							@foreach($blog_categories as $project)
							<tr>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="{!!route('blog_categories.show',['id'=>$project->id])!!}"><i class="fa fa-eye"></i> View</a>
											<a class="dropdown-item" href="{!!route('blog_categories.edit',['id'=>$project->id])!!}"><i class="fa fa-pencil"></i> Edit</a>
											<form action="{{route('blog_categories.destroy',$project->id)}}" method="POST">
											@method('DELETE')
											@csrf
