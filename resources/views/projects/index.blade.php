				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							...
							<a href="{!! route('projects.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-code"></i>Add Project</a>
						</div>
							</div>
						</div>
					</div>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="{!!route('projects.show',['id'=>$project->id])!!}"><i class="fa fa-eye"></i> View</a>
												<a class="dropdown-item" href="{!!route('projects.edit',['id'=>$project->id])!!}"><i class="fa fa-pencil"></i> Edit</a>
