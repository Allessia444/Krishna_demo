					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<div class="pull-right">
								<a href="{!! route('departments.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add Department</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
				<div class="row">
					<table class="data-table stripe hover nowrap">
						...
						<tbody>
							@foreach($departments as $industry)
							<tr>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="{!!route('departments.show',['id'=>$industry->id])!!}"><i class="fa fa-eye"></i> View</a>
											<a class="dropdown-item" href="{!!route('departments.edit',['id'=>$industry->id])!!}"><i class="fa fa-pencil"></i> Edit</a>
											<form action="{{route('departments.destroy',$industry->id)}}" method="POST">
												@method('DELETE')
												@csrf
